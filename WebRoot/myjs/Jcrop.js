  ...
  $.extend(Selection, {
    ...
    prototype: {
      ...
      startup: function() {
        ...
        t.element = $('<div />').addClass(o.css_selection).data({
          selection: t
        });
      ...
      center: function(instant) {
        var b = this.get(),
          m = this.core;
        var elw = m.container.width(),
          elh = m.container.height();
  ...
  $.extend(Thumbnailer, {
    ...
    prototype: {
      ...
      show: function() {
        ...
        if (!this.fading) this.element.stop().css({
          opacity: 1
        });
        else this.element.stop().animate({
          opacity: 1
        }, {
          duration: 80,
          queue: false
